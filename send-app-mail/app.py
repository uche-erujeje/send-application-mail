...
def send_email():
    ...
    message = f"""Thank You for Applying to EANDÉ Africa
...
2. **Assessment**: We will review all applications and send assessment links to successful candidates. This should be done in the next 1 week.
...
We appreciate your patience as we carefully review each application. If this role is not the right fit now, we encourage you to stay connected for future opportunities as we continue to grow.
